...
<div class='d-inline age_section mr-3'>
    ...
    <div class="container mt-4">
            ...
            $sql = "SELECT * FROM `last visit` Where `paitent_id` = '$sno'";
            $result = mysqli_query($connection, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo ' <div class="last_record">
                <h3>Last Visit Details</h3><p id="date"> Last Visit Date: <span>'.$row['date'].'</span></p> <div class="visit_box">
